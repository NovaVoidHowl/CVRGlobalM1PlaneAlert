...
using Constants = uk.novavoidhowl.dev.cvrglobalm1planealert.packagecore.Constants;

namespace uk.novavoidhowl.dev.cvrglobalm1planealert.nvhpmm
{
  public partial class ToolSetup : EditorWindow
  {
    private VisualElement RenderPrimaryDependencies()
    {
      ...
      foreach (var dependency in SharedData.PrimaryDependencies)
      {
        ...
        installStateSideBubble.AddToClassList("planeBubble");
